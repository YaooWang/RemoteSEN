...
![Image rectification to project the uncorrected image into the ground reference system: the geometric(Left) and radiometric(right) operations](05.jpg){width="500"}
